...
class ProvinceSchema(Schema):
    ...
    capital = fields.Str(required=True, error_messages={"required": "Campo obrigatório: capital"})
    area_km2 = fields.Float(required=True, error_messages={"required": "Campo obrigatório: area_km2"})
    populacao = fields.Int(required=True, error_messages={"required": "Campo obrigatório: populacao"})
