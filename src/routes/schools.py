...
def create_school():
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "message": f"Erro ao criar escola: {str(e)}"
        }), 500
...
def update_school(school_id):
    ...
    try:
        ...
        if updated_school:
            ...
            return jsonify({
                "success": False,
                "message": "Escola não encontrada ou município não pertence à província especificada"
            }), 404
        ...
        return jsonify({
            "success": False,
            "message": f"Erro ao atualizar escola: {str(e)}"
        }), 500
...
def delete_school(school_id):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "message": f"Erro ao deletar escola: {str(e)}"
        }), 500
