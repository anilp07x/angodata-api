...
# Models
province_model = provinces_ns.model(
    "Province",
    {
...
province_input = provinces_ns.model(
    "ProvinceInput",
    {
        "nome": fields.String(required=True, description="Nome da província", example="Luanda"),
        "capital": fields.String(required=True, description="Capital da província", example="Luanda"),
...
pagination_metadata = provinces_ns.model(
    "PaginationMetadata",
    {
...
province_list_response = provinces_ns.model(
...
province_response = provinces_ns.model(
    "ProvinceResponse", {"success": fields.Boolean(description="Status da operação"), "data": fields.Nested(province_model)}
)

bulk_create_input = provinces_ns.model(
    "BulkCreateProvinces",
    {"provinces": fields.List(fields.Nested(province_input), required=True, description="Lista de províncias para criar")},
)

bulk_update_item = provinces_ns.model(
    "BulkUpdateItem",
    {
...
error_response = provinces_ns.model(
    "ErrorResponse",
    {
