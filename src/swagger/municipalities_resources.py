...
class MunicipalityListResource(Resource):
    ...
    def get(self):
        ...
        if use_pagination:
            ...
            municipalities = MunicipalityService.get_all()
            return {"success": True, "total": len(municipalities), "data": municipalities}, 200
...
class MunicipalityResource(Resource):
    ...
    def get(self, id):
        ...
        if not municipality:
            return {"success": False, "message": f"Município com ID {id} não encontrado"}, 404

        return {"success": True, "data": municipality}, 200
    ...
    def put(self, id):
        ...
        return {"success": True, "message": "Município atualizado com sucesso", "data": updated}, 200
    ...
    def delete(self, id):
        ...
        if MunicipalityService.delete(id):
            return {"success": True, "message": f"Município ID {id} deletado com sucesso"}, 200
...
class MunicipalityCreateResource(Resource):
    ...
    def post(self):
        ...
        return {"success": True, "message": "Município criado com sucesso", "data": new_municipality}, 201
...
class MunicipalityByProvinceResource(Resource):
    ...
    def get(self, province_id):
        ...
        if not municipalities:
            return {"success": False, "message": f"Nenhum município encontrado para província ID {province_id}"}, 404
