...
class SchoolListResource(Resource):
    ...
    def get(self):
        ...
        if use_pagination:
            ...
            schools = SchoolService.get_all()
            return {"success": True, "total": len(schools), "data": schools}, 200
...
class SchoolResource(Resource):
    ...
    def get(self, id):
        ...
        if school:
            return {"success": True, "data": school}, 200

        return {"success": False, "message": "Escola não encontrada"}, 404
    ...
    def put(self, id):
        ...
        try:
            ...
            return {"success": True, "message": "Escola atualizada com sucesso", "data": updated_school}, 200
    ...
    def delete(self, id):
        ...
        return {"success": True, "message": "Escola removida com sucesso"}, 200
...
class SchoolCreateResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {"success": True, "message": "Escola criada com sucesso", "data": new_school}, 201
