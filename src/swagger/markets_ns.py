...
pagination_metadata = markets_ns.model(
    "PaginationMetadata",
    {
...
market_list_response = markets_ns.model(
    "MarketListResponse",
    {
...
market_response = markets_ns.model(
    "MarketResponse", {"success": fields.Boolean(description="Status da operação"), "data": fields.Nested(market_model)}
)

error_response = markets_ns.model(
    "ErrorResponse",
    {
