...
school_input = schools_ns.model('SchoolInput', {
    'nome': fields.String(required=True, description='Nome da escola'),
    'provincia_id': fields.Integer(required=True, description='ID da província'),
...
pagination_metadata = schools_ns.model('PaginationMetadata', {
...
school_list_response = schools_ns.model('SchoolListResponse', {
...
school_response = schools_ns.model('SchoolResponse', {
    'success': fields.Boolean(description='Status da operação'),
    'data': fields.Nested(school_model)
})

error_response = schools_ns.model('ErrorResponse', {
