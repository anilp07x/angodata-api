...
class MarketListResource(Resource):
    ...
    def get(self):
        ...
        if use_pagination:
            ...
            markets = MarketService.get_all()
            return {"success": True, "total": len(markets), "data": markets}, 200
...
class MarketResource(Resource):
    ...
    def get(self, id):
        ...
        if market:
            return {"success": True, "data": market}, 200

        return {"success": False, "message": "Mercado não encontrado"}, 404
    ...
    def put(self, id):
        ...
        try:
            ...
            return {"success": True, "message": "Mercado atualizado com sucesso", "data": updated_market}, 200
    ...
    def delete(self, id):
        ...
        return {"success": True, "message": "Mercado removido com sucesso"}, 200
...
class MarketCreateResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {"success": True, "message": "Mercado criado com sucesso", "data": new_market}, 201
