...
# Models
municipality_model = municipalities_ns.model(
    "Municipality",
    {
...
municipality_input = municipalities_ns.model(
    "MunicipalityInput",
    {
        "nome": fields.String(required=True, description="Nome do município", example="Luanda"),
        "provincia_id": fields.Integer(required=True, description="ID da província", example=1),
...
pagination_metadata = municipalities_ns.model(
    "PaginationMetadata",
    {
...
municipality_list_response = municipalities_ns.model(
...
municipality_response = municipalities_ns.model(
    "MunicipalityResponse",
    {"success": fields.Boolean(description="Status da operação"), "data": fields.Nested(municipality_model)},
)

error_response = municipalities_ns.model(
    "ErrorResponse",
    {
