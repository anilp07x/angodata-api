...
hospital_model = hospitals_ns.model(
    "Hospital",
    {
...
hospital_input = hospitals_ns.model(
    "HospitalInput",
    {
        "nome": fields.String(required=True, description="Nome do hospital"),
        "provincia_id": fields.Integer(required=True, description="ID da província"),
...
pagination_metadata = hospitals_ns.model(
    "PaginationMetadata",
    {
...
hospital_list_response = hospitals_ns.model(
...
hospital_response = hospitals_ns.model(
    "HospitalResponse", {"success": fields.Boolean(description="Status da operação"), "data": fields.Nested(hospital_model)}
)

error_response = hospitals_ns.model(
    "ErrorResponse",
    {
